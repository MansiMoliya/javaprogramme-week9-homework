...
public class Programme2_MarkSheet {
    public static void main(String[] args) {
        ...
        markSheet(sub1,sub2,sub3,num);
    }
    public static void markSheet(int sub1,int sub2,int sub3,int num) {
        int total = sub1 + sub2 + sub3;
        int per = total / 3;
//        String result = calculateResult(sub1, sub2, sub3);
//        String grade = calculateGrade(per, result);
//        int num;
        String name="";
        String result = "";
        String grade = "";
